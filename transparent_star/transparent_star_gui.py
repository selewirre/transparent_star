...
from transparent_star.transparent_star_functions import get_transparent_star
...
class ImageProcessingWorker(QObject):
    ...
    def run(self, image_name, luminance_stop, transparency_power_decay):
        self.progress.emit(f"Processing {image_name.split('/')[-1]}...")
        image = get_transparent_star(image_name, luminance_stop, transparency_power_decay)
        self.progress.emit(f'Transparent Sol is ready!')
...
class Window(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Transparent Sol")
        self.resize(600, 450)
